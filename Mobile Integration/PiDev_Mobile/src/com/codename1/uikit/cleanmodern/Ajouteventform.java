...
public class Ajouteventform  extends BaseForm {
    ...
    public Ajouteventform(Resources res)
    {
        ...
        RadioButton mesListes = RadioButton.createToggle("Event", barGroup);
        ...
        TextField nbr = new TextField ("","Enter A nombre de place !!");
        nbr.setUIID("textFieldBlack");
        addStringValue("nbr",nbr);
        
              TextField par_id = new TextField ("","Enter A par_id !!");
        par_id.setUIID("textFieldBlack");
        addStringValue("par_id",par_id);
        ...
        addStringValue("description",description);
           ...
           TextField image = new TextField ("","Enter A image  !!");
        image.setUIID("textFieldBlack");
        addStringValue("image",image);
        
  TextField categorie = new TextField ("","Enter A categorie  !!");
        ...
        {
            try {
                if (nbr.getText().equals("")|| par_id.getText().equals("")|| description.getText().equals(" ")||image.getText().equals(" ")|| categorie.getText().equals(" "))
                {
                ...
                else
                {
                    ...
                    Event r = new Event(Integer.parseInt(nbr.getText()),
                            Integer.parseInt(par_id.getText()),
