...
public class Payment { Customer a=new Customer();
    ...
    public Payment() {
        Stripe.apiKey = "sk_test_51IXnu2Ia1QXbZEIfeNS1cTsRP29IZawAtsrPFbAqg0HYa90Uog5vEvYMx4u6blLzlknmJMwAvkTOS8z6msvp2Usn00EfPsgyeX";
  ...
  /*public void createCustomer() {
    ...
    public void RetrieveCustomer(){
        try {
            Customer a=Customer.retrieve("cus_JDqwZqbdKtrxes");
...
//            a.getSources().create(source);
    ...
    public void payement(int prix){
        ...
        try {Customer a=Customer.retrieve("cus_JDqwZqbdKtrxes");
