...
public class serviceEvent {
                ...
                public void ajoutReclamation(Event event )
    {
                     ...
                     public void ajoutEvent(Event e)
     {
        ...
        public boolean modifierPar(Participant e)
{
      String url=Statics.BASE_URL+"/participant/updatepar?id="+e.getId()+"&user="+e.getUser()+"&eventid="+e.getEventid()+"&&nom="+e.getNom()+"&mail="+e.getMail()+"&mobile="+e.getMobile();
...
return resultOK;
       ...
       public void ajoutPar(Participant par)
     {
          String url = Statics.BASE_URL+"/participant/addparticipant?user="+par.getUser()+"&eventid="+par.getEventid()+"&nom="+par.getNom()+"&mail="+par.getNom()+"&mobile="+par.getMobile();
         req.setUrl(url);
         req.addResponseListener((el) ->
         {
             String str = new String(req.getResponseData());
    ...
    try{
       ...
       for(Map<String,Object> obj:listOfMaps)
       {
           ...
           float id =Float.parseFloat(obj.get("id").toString());
             ...
             float par_id =Float.parseFloat(obj.get("parId").toString());
