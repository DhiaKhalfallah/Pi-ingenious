...
public class AddCommentaireController implements Initializable {
    ...
    add.setOnAction(event -> {
      ...
      System.out.println(x);
        ...
        alert.show();
        Image img = new Image("/art_comm/Views/img/images-removebg-preview.png");
        Notifications notificatoinBuilder = Notifications.create()
                .title(" ADD SUCCESSFUL")
                .text("Commentaire Added ")
      ...
      // mailing 
        ...
        String emailsubject="Jobby Commentaire Added";
        String emailbody="Hello User with the ID: "+user.getText()+
                ", A Commentaire has been added in Jobby with a title  "+
      ...
      try {
        ...
        alert.setTitle("Information Dialog");
        alert.setHeaderText(null);
        alert.setContentText("Commentaire Added check your Mail");
        alert.show();
                    }             //  }
        });
